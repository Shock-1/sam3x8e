...
impl crate::ToBits<u8> for TRGSEL_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
...
impl crate::ToBits<bool> for SLEEP_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
...
impl crate::ToBits<bool> for FWUP_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
            FWUP_A::OFF => false,
...
impl crate::ToBits<bool> for FREERUN_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
            FREERUN_A::OFF => false,
...
impl crate::ToBits<u8> for SETTLING_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            SETTLING_A::AST3 => 0,
...
impl crate::ToBits<bool> for ANACH_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
            ANACH_A::NONE => false,
...
impl crate::ToBits<bool> for USEQ_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
