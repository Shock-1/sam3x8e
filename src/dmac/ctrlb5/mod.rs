...
impl crate::ToBits<bool> for SRC_DSCR_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
...
impl crate::ToBits<bool> for DST_DSCR_A {
    #[inline(always)]
    fn _bits(&self) -> bool {
        match *self {
...
impl crate::ToBits<u8> for SRC_INCR_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
...
impl crate::ToBits<u8> for DST_INCR_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
