...
impl crate::ToBits<u8> for EEVTEDG_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            EEVTEDG_A::NONE => 0,
...
impl crate::ToBits<u8> for EEVT_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            EEVT_A::TIOB => 0,
...
impl crate::ToBits<u8> for WAVSEL_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            WAVSEL_A::UP => 0,
...
impl crate::ToBits<u8> for ACPA_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            ACPA_A::NONE => 0,
...
impl crate::ToBits<u8> for ACPC_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            ACPC_A::NONE => 0,
...
impl crate::ToBits<u8> for AEEVT_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            AEEVT_A::NONE => 0,
...
impl crate::ToBits<u8> for ASWTRG_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            ASWTRG_A::NONE => 0,
...
impl crate::ToBits<u8> for BCPB_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            BCPB_A::NONE => 0,
...
impl crate::ToBits<u8> for BCPC_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            BCPC_A::NONE => 0,
...
impl crate::ToBits<u8> for BEEVT_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            BEEVT_A::NONE => 0,
...
impl crate::ToBits<u8> for BSWTRG_A {
    #[inline(always)]
    fn _bits(&self) -> u8 {
        match *self {
            BSWTRG_A::NONE => 0,
